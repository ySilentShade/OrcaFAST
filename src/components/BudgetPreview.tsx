...
const BudgetPreview: React.FC<BudgetPreviewProps> = ({ data }) => {
  ...
  return (
    <Card id="budget-preview-content" className="sticky top-8 shadow-lg h-[calc(100vh-4rem)] overflow-auto" style={{ backgroundColor: '#18191b', color: '#e0e0e0' }}>
      <CardHeader className="p-8 border-b border-gray-600">
        <div className="flex justify-between items-start">
          ...
          <div className="text-right">
            <h1 className="text-3xl font-bold text-gray-100">ORÇAMENTO</h1>
            <p className="text-sm text-gray-400">Número: {budgetNumber}</p>
            <p className="text-sm text-gray-400">Data: {budgetDate}</p>
          </div>
        </div>
      </CardHeader>
      <CardContent className="p-8">
        ...
        <div className="mb-6">
          ...
          <Table className="text-gray-300">
            <TableHeader>
              <TableRow className="border-b border-gray-600 hover:bg-gray-700/30">
            ...
            <TableBody>
              {items.map((item) => (
                <TableRow key={item.id} className="border-b border-gray-600 hover:bg-gray-700/30">
